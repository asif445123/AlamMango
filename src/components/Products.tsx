      ...
      <div className="wrap">
        <div className="sec-head">
          <span className="eyebrow">
            <span className="dot" /> Our Harvest
          </span>

          <h2>Pick your favourite premium mangoes</h2>

          <p>
            Every box of premium mangoes is packed fresh on order.
            Choose your variety and box size — we deliver free to your door.
          </p>
          ...
          >
            Box weights are approximate (around 10kg or 5kg) and may vary
            slightly, since no two mangoes are the same size.
          </p>
        </div>
        ...
        <div className="grid" id="productGrid">
          {products.map(product => {
            const price =
              activeSize === 10 ? product.price10 : product.price5;
