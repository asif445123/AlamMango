    ...
    <section id="top" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center pt-20">
        <div className="inline-block mb-6 px-4 py-1.5 rounded-full bg-amber-500/20 border border-amber-400/30 backdrop-blur-sm">
          <span className="text-amber-200 text-sm font-medium tracking-wide">🥭 Season 2026 — Now Accepting Orders</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="#mangoes"
            className="inline-flex items-center justify-center px-8 py-4 bg-amber-500 hover:bg-amber-600 text-white font-semibold rounded-xl transition-all shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40 hover:-translate-y-0.5"
          >
            Shop Mangoes
          ...
          <a
            ...
            className="inline-flex items-center justify-center px-8 py-4 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-xl transition-all backdrop-blur-sm border border-white/20"
          >
